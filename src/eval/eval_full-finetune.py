...
def main(args):
    ...
    # -------------------------------
    t0 = time.time()
    args.save_dir = f"/ssl-jet-vol-v2/JetCLR/models/model_performances/finetuning/{args.label}"
    ...
    args.load_path = f"/ssl-jet-vol-v2/JetCLR/models/finetuning/{args.label}/simclr_finetune_best_acc.pt"
